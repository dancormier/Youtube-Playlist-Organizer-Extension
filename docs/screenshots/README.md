...
|---|---|---|
| `modal.png` | The preview after **Analyze & sort**: sort options collapsed, two or three group headings with counts and time left, one started video hovered so the eye control is visible | Open the playlist, click **Organize** → **Analyze & sort**, wait for the preview, hover a row that reads `2:14 / 5:24` |
