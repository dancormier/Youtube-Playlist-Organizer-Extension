...
8. **Apply and headings.** Apply the AI sort. After the reload the headings sit above the right videos, and a **Hide headings** chip sits at the end of the chip row, after Shorts. Drag a video to a new position: YouTube's own drag-to-reorder must still work.
