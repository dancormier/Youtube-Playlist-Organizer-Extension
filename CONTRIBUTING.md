...
9. **Headings toggle.** Click **Hide headings**: they disappear and the chip reads **Show headings**. Reload: still hidden, chip still says Show. Click it: they come back. In the inspector, each heading is the first child of its `ytd-playlist-video-renderer`; with a screen reader, the heading is announced before the video. Then pick **Date added (newest)** in YouTube's own sort chip: the headings and the chip disappear at once, and switching back to Manual does not bring them back.
